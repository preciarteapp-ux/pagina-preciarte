...
import { Check, Sparkles, Tag, Shield, RefreshCw, PiggyBank, Minus } from "lucide-react";
...
const PricingLP2 = ({ discountApplied = false }: PricingLP2Props) => {
  const annualLink = "https://pay.onprofit.com.br/CUTCm7GF?off=0jene1";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto items-start">
          ...
          <div className="relative bg-card rounded-2xl p-8 border-2 border-primary shadow-[var(--shadow-glow)] md:scale-105">
            ...
            <Button
              ...
              data-track-id="checkout-lp2-anual"
          ...
          <div className="relative bg-card rounded-2xl p-8 border-2 border-border">
            ...
            <Button
              ...
              data-track-id="checkout-lp2-mensal"
              data-track-type="checkout"
            >
              Assinar Mensal
            </Button>
