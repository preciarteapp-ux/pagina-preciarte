...
const PERGUNTAS = [
  {
    q: 'Por que só o plano anual nesta oferta?',
    a: 'Porque o sistema só devolve resultado depois que você cadastra seus materiais e seus produtos. Isso leva uma tarde, e o retorno aparece nos meses seguintes. Um ano é o prazo honesto para essa conta fechar — e é o que permite o preço cair deste tanto.',
  },
  {
    q: 'Esse preço volta a subir depois?',
    a: 'Sim. Fora da campanha o plano anual custa R$ 139,90, e o mensal R$ 39,90 por mês. Não vou inventar um relógio na tela: a oferta acaba quando a campanha acabar, e aí o valor volta ao normal.',
  },
  {
  ...
  },
  {
    ...
    a: 'Você tem 7 dias para pedir reembolso, integral se não tiver usado créditos de IA. Se tiver usado, é descontado R$ 1,00 a cada 10 créditos consumidos. O plano anual não renova sozinho sem aviso: quando os doze meses acabarem, você decide se continua.',
  },
  {
...
const Faq = () => (
  <section id="duvidas" className="bg-bf-bone pb-[72px] lg:pb-[130px]">
    <div className="max-w-bf-prose mx-auto px-5 lg:px-8">
      <Reveal className="text-center">
        <Badge tone="light">Dúvidas</Badge>
        <h2 className={`${T.h2} text-bf-text mt-6`}>Perguntas que aparecem antes de decidir</h2>
      </Reveal>
          ...
          <Reveal key={p.q} delay={i * 50}>
            <details open={i === 0} className="bf-acc group bg-white rounded-[20px] px-6 py-5">
              ...
              <div className="bf-acc-body">
                <div><p className={`${T.small} text-bf-muted pt-4 max-w-[62ch]`}>{p.a}</p></div>
              </div>
            </details>
          </Reveal>
        ))}
