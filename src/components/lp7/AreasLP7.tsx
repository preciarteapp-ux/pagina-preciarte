...
const AreasLP7 = () => (
  <section className="relative overflow-hidden bg-lp7-ink py-[72px] lg:py-[120px]">
    ...
    <div className="relative max-w-lp7-container mx-auto px-5 lg:px-8">
      <Reveal className="text-center">
        ...
        <p className={`${T.body} text-white/55 mt-5 max-w-[54ch] mx-auto`}>
