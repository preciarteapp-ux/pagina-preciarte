    ...
    <div className="container mx-auto px-4 max-w-6xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5">
        {benefits.map((b, i) => {
          const Icon = b.icon;
          return (
            <div key={i} className="rounded-2xl p-5 md:p-6 transition-all hover:-translate-y-1" style={{ background: "rgba(255,255,255,0.92)", border: "1px solid rgba(212,175,55,0.35)", boxShadow: "0 10px 28px rgba(154,31,74,0.1)" }}>
              <div className="w-11 h-11 md:w-12 md:h-12 rounded-xl flex items-center justify-center mb-3 md:mb-4" style={{ background: "linear-gradient(135deg,#c2185b,#d4af37)" }}>
