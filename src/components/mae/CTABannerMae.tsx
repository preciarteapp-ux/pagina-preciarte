...
const CTABannerMae = () => {
  ...
  return (
    <section className="relative py-10 md:py-14" style={{ background: "#fff8f0" }}>
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="rounded-2xl md:rounded-3xl p-6 md:p-10 text-center relative overflow-hidden" style={{ background: "linear-gradient(135deg,#9a1f4a 0%,#c2185b 50%,#d4af37 100%)", boxShadow: "0 20px 50px rgba(154,31,74,0.35)" }}>
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/90 text-sm md:text-base mb-5 md:mb-6 max-w-2xl mx-auto">
              Garanta agora pelo melhor preço do ano. A partir de <strong>R$ 12,56<span className="text-sm font-normal">/mês</span></strong> no Plano Anual.
            </p>
