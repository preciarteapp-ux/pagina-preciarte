...
const FeaturesMae = () => (
  <section className="relative py-12 md:py-20 overflow-hidden" style={{ background: "linear-gradient(180deg,#fff8f0 0%,#fde7ed 100%)" }}>
    <div className="container mx-auto px-4 max-w-5xl">
      ...
      <div className="rounded-2xl md:rounded-3xl p-5 md:p-10" style={{ background: "rgba(255,255,255,0.9)", border: "1px solid rgba(212,175,55,0.4)", boxShadow: "0 16px 40px rgba(154,31,74,0.12)" }}>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 md:gap-3">
          {features.map((f, i) => (
            <div key={i} className="flex items-start gap-2.5 md:gap-3">
              <div className="w-5 h-5 md:w-6 md:h-6 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5" style={{ background: "linear-gradient(135deg,#c2185b,#d4af37)" }}>
