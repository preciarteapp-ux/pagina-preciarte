    ...
    <div className="mx-auto w-full max-w-xl px-5 pt-6 pb-32 animate-fade-in">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="relative mt-6 rounded-2xl border-2 border-accent/60 bg-accent/10 p-5 text-left">
            <div className="absolute -top-3 right-4">
              <div className="rounded-full bg-accent px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-accent-foreground shadow-lg">
                Melhor oferta
              </div>
            </div>
            <div className="mt-1 mb-2">
              <span className="rounded-full bg-accent/30 px-2.5 py-0.5 text-[11px] font-bold text-accent">
                48% OFF
              </span>
            </div>
            <div className="text-xs text-white/40 line-through">R$ 478,80/ano</div>
            <div className="font-display text-3xl font-extrabold leading-tight text-white">
              12x R$ 14,48
            </div>
            <div className="mt-0.5 text-xs text-white/50">ou R$ 139,90 à vista</div>

            <div className="mt-3 flex items-center gap-2 rounded-lg border border-emerald-500/30 bg-emerald-500/10 px-2.5 py-2">
              <PiggyBank className="h-3.5 w-3.5 flex-shrink-0 text-emerald-400" />
            ...
            <ul className="mt-3 space-y-1.5">
              {[
                ...
                <li key={f} className="flex items-start gap-2 text-[13px] text-white/80">
                  <Check className="h-3.5 w-3.5 flex-shrink-0 mt-0.5 text-emerald-400" strokeWidth={3} />
                  <span>{f}</span>
                </li>
              ))}
            </ul>
            ...
            <button
              ...
              className="mt-4 flex w-full items-center justify-center gap-2 rounded-full bg-accent px-6 py-4 font-display text-[15px] font-bold text-accent-foreground shadow-[0_8px_30px_hsl(var(--accent)/0.4)] transition-all hover:-translate-y-0.5 hover:shadow-[0_12px_40px_hsl(var(--accent)/0.55)]"
            >
              Assinar Anual agora
          ...
          <div className="mt-3 rounded-2xl border border-white/15 bg-white/[0.04] p-5 text-left">
            ...
            <div className="mt-0.5 text-xs text-white/50">Acesso completo, sem fidelidade</div>
            ...
            <button
              ...
              data-track-type="checkout"
              className="mt-4 flex w-full items-center justify-center gap-2 rounded-full border border-white/30 bg-transparent px-6 py-3 font-display text-[14px] font-bold text-white transition-all hover:bg-white/10"
            >
              Assinar Mensal
              <ArrowRight className="h-4 w-4" />
            </button>

            <div className="mt-3 rounded-lg border border-white/10 bg-white/[0.03] px-2.5 py-2 text-center">
              <p className="text-[11px] text-white/60">
                No anual você paga <span className="font-bold text-accent">R$ 14,48/mês</span> — apenas 36% do preço mensal
              </p>
            </div>
          </div>
