...
:root{
  ...
  --text-dark:#100812;
  --text-light:#fdf5f8;
  --text-muted:rgba(253,245,248,0.5);
  --text-muted-dark:rgba(16,8,18,0.5);
  --border-dark:rgba(255,255,255,0.08);
  --border-light:rgba(16,8,18,0.1);
  --glow:rgba(192,48,90,0.28);
}
...
.hero::before{
  ...
  background:radial-gradient(circle,rgba(192,48,90,0.22) 0%,transparent 70%);
...
.hero-pill{
  ...
  background:rgba(192,48,90,0.15);border:1px solid rgba(192,48,90,0.3);
...
.iphone{
  width:260px;background:#1a0e14;border-radius:40px;
  border:1px solid rgba(255,255,255,.12);padding:14px;
  box-shadow:0 0 0 1px rgba(255,255,255,.05),0 50px 100px rgba(0,0,0,.7),0 0 80px rgba(192,48,90,.2);
...
.mb-calc{
  background:rgba(192,48,90,.15);border:1px solid rgba(192,48,90,.3);
...
.schip.on{background:rgba(192,48,90,.2);border-color:rgba(192,48,90,.4);color:var(--brand3)}

.fc{
  position:absolute;background:#1a0e14;border:1px solid rgba(255,255,255,.1);
  border-radius:16px;padding:14px 18px;
  box-shadow:0 20px 60px rgba(0,0,0,.6),0 0 30px rgba(192,48,90,.1);z-index:3;
}
...
.fpill.orange{background:rgba(192,48,90,.15);color:var(--brand2);border:1px solid rgba(192,48,90,.25)}
.fsec.light .fpill.orange{background:rgba(192,48,90,.12);color:var(--brand)}
...
.fsec.dark .fchip-dot{background:rgba(192,48,90,.2);color:var(--brand2)}
.fsec.light .fchip-dot{background:rgba(192,48,90,.15);color:var(--brand)}

.pwin{border-radius:20px;overflow:hidden;box-shadow:0 32px 80px rgba(0,0,0,.3)}
.fsec.dark .pwin{background:#1a0e14;border:1px solid rgba(255,255,255,.08);box-shadow:0 32px 80px rgba(0,0,0,.6),0 0 60px rgba(192,48,90,.08)}
...
.how-n{
  ...
  margin:0 auto 18px;box-shadow:0 8px 24px rgba(192,48,90,.35);
}
...
.pc.feat{background:var(--bg-dark);border:1.5px solid rgba(192,48,90,.4);box-shadow:0 0 60px rgba(192,48,90,.15)}
.pc-badge{
...
.pc-btn{
  ...
  transition:all .2s;box-shadow:0 8px 24px rgba(192,48,90,.35);
}
.pc-btn:hover{transform:translateY(-1px);box-shadow:0 12px 32px rgba(192,48,90,.45)}
...
footer{background:#0e0810;padding:28px 80px;display:flex;align-items:center;justify-content:space-between;border-top:1px solid var(--border-dark)}
.float-bar{position:fixed;bottom:24px;right:24px;display:flex;align-items:center;gap:10px;z-index:9999}
.float-label{background:#1a0a0a;color:#fff;font-size:13px;font-weight:600;padding:8px 16px;border-radius:100px;border:1px solid rgba(255,255,255,0.12);white-space:nowrap;box-shadow:0 4px 16px rgba(0,0,0,0.4)}
.float-wa{width:52px;height:52px;border-radius:50%;background:#25d366;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 16px rgba(37,211,102,0.4);transition:transform .2s,box-shadow .2s;flex-shrink:0}
.float-wa:hover{transform:scale(1.08);box-shadow:0 6px 24px rgba(37,211,102,0.55)}
...
.diff-card-on{background:#fff;border:1.5px solid rgba(192,48,90,.3);border-radius:14px;padding:26px 22px;box-shadow:0 4px 20px rgba(192,48,90,.08)}
...
.diff-badge-on{display:inline-block;background:rgba(192,48,90,.12);color:var(--brand);font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.07em;border-radius:6px;padding:4px 12px;margin-bottom:16px}
...
const LP4 = () => {
  ...
  const faqs = [
    ...
    {
      q: "Tá caro.",
      a: "R$ 14,91 por mês — menos que um kit de material. Quando você ajusta o preço do primeiro pedido com o cálculo certo, já recuperou o ano inteiro. 87% das clientes descobrem no primeiro uso que estavam cobrando abaixo do ideal.",
    },
    {
    ...
    <>
      ...
      <section id="pricing" className="pricing">
        ...
        <div className="pricing-wrap">
          <div className="pc feat" style={{ width: '360px' }}>
            ...
            <p className="pc-price"><sup>R$</sup>14<span style={{ fontSize: '28px' }}>,91</span><span style={{ fontSize: '18px', fontWeight: 500, opacity: 0.7, marginLeft: '4px' }}>/mês</span></p>
            <p className="pc-per">ou R$ 139,90 à vista no plano anual</p>
            <p className="pc-save">Você economiza R$ 338,90 no ano</p>
      ...
      <section className="final">
        <div className="final-box">
          ...
          <p className="final-sub">R$ 14,91 por mês. Acesso imediato.</p>
      ...
      <div className="float-bar">
        <span className="float-label">Dúvidas?</span>
        <a
          className="float-wa"
          href="https://wa.me/5564996259223?text=Estou%20no%20site%20e%20estou%20com%20d%C3%BAvida%20sobre%20o%20PreciArte"
          target="_blank"
