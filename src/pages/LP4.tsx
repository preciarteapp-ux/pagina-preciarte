...
const LP4 = () => {
  ...
  const faqs = [
    ...
    {
      q: "Tá caro.",
      a: "R$ 12,56 por mês — menos que um kit de material. Quando você ajusta o preço do primeiro pedido com o cálculo certo, já recuperou o ano inteiro. 87% das clientes descobrem no primeiro uso que estavam cobrando abaixo do ideal.",
    },
    {
    ...
    <>
      ...
      <section id="pricing" className="pricing">
        ...
        <div className="pricing-wrap">
          <div className="pc feat" style={{ width: '360px' }}>
            ...
            <p className="pc-price"><sup>R$</sup>12<span style={{ fontSize: '28px' }}>,56</span><span style={{ fontSize: '18px', fontWeight: 500, opacity: 0.7, marginLeft: '4px' }}>/mês</span></p>
            <p className="pc-per">ou R$ 117,90 à vista no plano anual</p>
      ...
      <section className="final">
        <div className="final-box">
          ...
          <p className="final-sub">R$ 12,56 por mês. Acesso imediato.</p>
